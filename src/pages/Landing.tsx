        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <div className="relative w-20 h-20 mx-auto">
              ...
              >
                <div className="w-12 h-12 bg-gradient-to-br from-red-400 to-pink-400 rounded-full blur-lg opacity-40" />
              </motion.div>
              ...
              {[0, 60, 120, 180, 240, 300].map((angle, i) => (
                ...
                >
                  <div className="w-1.5 h-1.5 bg-red-500 rounded-full shadow-sm" style={{ transform: `translate(-50%, -40px)` }}>
                    <motion.div
              ...
              >
                <Sparkles className="w-8 h-8 text-red-600 opacity-90" />
              </motion.div>
            </div>
          </motion.div>
          ...
          >
            ...
            <span className="block text-2xl md:text-3xl font-semibold text-red-600 mb-4">
              That Gets Smarter Every Day
            </span>
            <span className="block text-xl md:text-2xl font-medium text-gray-600">
          ...
          >
            ...
            <motion.div
              ...
              className="relative group bg-white/90 backdrop-blur-sm border border-green-200 rounded-xl p-6 hover:border-green-400 hover:shadow-lg hover:shadow-green-100 transition-all duration-300 cursor-pointer"
            >
              <CheckCircle2 className="w-10 h-10 text-green-600 mb-3 mx-auto group-hover:scale-105 transition-transform" strokeWidth={1.5} />
            ...
            <motion.div
              whileHover={{ scale: 1.03, y: -4 }}
              className="relative group bg-white/90 backdrop-blur-sm border border-blue-200 rounded-xl p-6 hover:border-blue-400 hover:shadow-lg hover:shadow-blue-100 transition-all duration-300 cursor-pointer"
            >
              <Lock className="w-10 h-10 text-blue-600 mb-3 mx-auto group-hover:scale-105 transition-transform" strokeWidth={1.5} />
            ...
            <motion.div
              whileHover={{ scale: 1.03, y: -4 }}
              className="relative group bg-white/90 backdrop-blur-sm border border-amber-200 rounded-xl p-6 hover:border-amber-400 hover:shadow-lg hover:shadow-amber-100 transition-all duration-300 cursor-pointer"
            >
              <Shield className="w-10 h-10 text-amber-600 mb-3 mx-auto group-hover:scale-105 transition-transform" strokeWidth={1.5} />
          ...
          >
            <Link to="/main">
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="group relative px-10 py-4 bg-red-600 border border-red-600 rounded-full text-white font-semibold text-lg shadow-xl hover:bg-red-700 hover:shadow-2xl hover:shadow-red-200 transition-all"
              >
